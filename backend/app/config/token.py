# Механизм авторизации и защиты API интернет-магазина через JWT
...
# 	создаёт токен после логина
#   проверяет подлинность токена
#   определяет, кто выполняет запрос
#   защищает личный кабинет, заказы, добавление товаров
