# API для управления товарами магазина, с поддержкой CRUD, рекомендаций и экспорта.
...
#	управляет товарами: просмотр, создание, редактирование, удаление
#	предоставляет CSV-экспорт для отчётов
#	поддерживает рекомендации для фронтенда
