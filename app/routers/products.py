...
def read_products(
    ...
    """Получить список товаров (доступно всем)"""
...
# Защищенные эндпоинты (только для админов и менеджеров)
...
def create_product(
    ...
    """Создать товар (только админ/менеджер)"""
...
def update_product(
    ...
    """Обновить товар (только админ/менеджер)"""
...
def delete_product(
    ...
    """Удалить товар (только админ/менеджер)"""
